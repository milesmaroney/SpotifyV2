import { ViewListIcon, VolumeUpIcon as VolumeDownIcon } from "@heroicons/react/outline";
import { FastForwardIcon, PauseIcon, PlayIcon, RefreshIcon, ReplyIcon, RewindIcon, SwitchHorizontalIcon, VolumeUpIcon } from "@heroicons/react/solid";
  ...
  return (
    <div className="h-24 bg-gradient-to-b from-black to-gray-900 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-8">
      ...
      <div className="flex items-center space-x-3 md:space-x-4 justify-end pr-5">
        ...
        <input className="w-15 md:w-30" type="range" value ={volume} min={0} max={100}
